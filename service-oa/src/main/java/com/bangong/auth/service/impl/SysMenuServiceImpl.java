...
import com.bangong.auth.MenuHelper.MenuHelper;
import com.bangong.auth.mapper.SysMenuMapper;
import com.bangong.auth.mapper.SysRoleMenuMapper;
import com.bangong.auth.service.SysMenuService;
import com.bangong.auth.service.SysRoleService;
import com.bangong.common.execption.BanGongException;
import com.bangong.model.system.SysMenu;
import com.bangong.model.system.SysRoleMenu;
import com.bangong.vo.system.AssginMenuVo;
import com.bangong.vo.system.MetaVo;
import com.bangong.vo.system.RouterVo;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper,SysMenu> implements SysMenuService {
    ...
    public boolean removeById(Serializable id) {
        ...
        if (count > 0) {
            throw new BanGongException(201,"菜单不能删除");
        }
